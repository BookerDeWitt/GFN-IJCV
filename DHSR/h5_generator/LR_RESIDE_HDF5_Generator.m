...
%%
function LR_RESIDE_HDF5_Generator(folder)
scale = 4;
size_label = 256;
size_input = size_label/scale;
stride = 128;

save_root =fullfile(folder, sprintf('RESIDE_train%d_%dx_HDF5', size_label, scale));
...
y = [1000 2000 3000 4000 5000 6000 7000 8000 9000 10004];
